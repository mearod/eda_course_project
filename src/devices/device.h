...
public:
    ...
    Capacitor(std::string name,std::string pos,std::string neg,double c_value): BaseDevice(name,B_TYPE,C),BTypeDevice(name),pos(pos),neg(neg),c_value(c_value){};
...
public:
    ...
    Cs(std::string name,std::string pos,std::string neg,double dc_value,double ac_value)
    : BaseDevice(name,G_TYPE,ISOURCE),pos(pos),neg(neg),dc_value(dc_value),ac_value(ac_value){};
